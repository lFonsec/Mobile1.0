...
import com.example.lucas.multimidia.model.Autor;
...
public class AutorDAO {
	...
	public AutorDAO(Context ctx) {
		// Abre o banco de dados ja existente
		db = ctx.openOrCreateDatabase(NOME_BANCO, Context.MODE_PRIVATE, null);
	}

	// Salva o autor, insere um novo ou atualiza
	public long salvar(com.example.lucas.multimidia.model.Autor autor) {
		long id = autor.getId();
	...
	public List<Autor> listarAutores() {
		Cursor c = db.query("autor", new String[]{"_id", "nome", "endereco", "cpf"}, null, null, null, null, null, null);

		List<com.example.lucas.multimidia.model.Autor> autores = new ArrayList<Autor>();
	...
	public Autor buscarAutor(long id) {
		...
		Cursor c = db.query(true, "autor",  new String[] { "_id", "nome", "endereco", "cpf" },  "_id" + "=" + id, null, null, null, null, null);
	...
	public Autor buscarAutorPorNome(String nome) {
		...
		try {
			...
			Cursor c = db.query("autor", new String[] { "_id", "nome", "endereco", "cpf" }, "nome" + "='" + nome + "'", null, null, null, null);
